  ...
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              mission is to enable premium quality care for your luxury car
              service at affordable pricing . We ensure real-time updates for
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Bumper Repair</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Accidental Repair</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Scratch Removal</a>
            </p>
          </div>
          ...
          <div className="">
            ...
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Enquiry</a>
            </p>
          </div>
          {/* <!-- Contact section --> */}
          <div>
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
        ...
        >
         Top Notch Auto Care. All rights reserved.
        </a>
      </div>
    </footer>
  );
